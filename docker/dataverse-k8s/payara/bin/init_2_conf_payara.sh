...
echo "create-javamail-resource --mailhost=${MAIL_SERVER} --mailuser=dataversenotify --fromaddress=do-not-reply@${HOST_DNS_ADDRESS} mail/notifyMailSession" >> ${DV_POSTBOOT}
